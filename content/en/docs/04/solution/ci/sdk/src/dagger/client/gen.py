...
class TrivyID(Scalar):
    """The `TrivyID` scalar type represents an identifier for an object of
    type Trivy."""


class TrivyScanID(Scalar):
    """The `TrivyScanID` scalar type represents an identifier for an
    object of type TrivyScan."""
...
class Binding(Type):
    ...
    def as_trivy(self) -> "Trivy":
        """Retrieve the binding value, as type Trivy"""
        _args: list[Arg] = []
        _ctx = self._select("asTrivy", _args)
        return Trivy(_ctx)

    def as_trivy_scan(self) -> "TrivyScan":
        """Retrieve the binding value, as type TrivyScan"""
        _args: list[Arg] = []
        _ctx = self._select("asTrivyScan", _args)
        return TrivyScan(_ctx)
...
class Env(Type):
    ...
    def with_trivy_input(self, name: str, value: "Trivy", description: str,) -> Self:
        ...
        name:
            The name of the binding
        value:
            The Trivy value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withTrivyInput", _args)
        return Env(_ctx)

    def with_trivy_output(self, name: str, description: str) -> Self:
        ...
        _ctx = self._select("withTrivyOutput", _args)
        return Env(_ctx)

    def with_trivy_scan_input(self, name: str, value: "TrivyScan", description: str,) -> Self:
        """Create or update a binding of type TrivyScan in the environment
        ...
        name:
            The name of the binding
        value:
            The TrivyScan value to assign to the binding
        description:
            The purpose of the input
        """
        _args = [
        ...
        _ctx = self._select("withTrivyScanInput", _args)
        return Env(_ctx)

    def with_trivy_scan_output(self, name: str, description: str) -> Self:
        """Declare a desired TrivyScan output to be assigned in the environment
        ...
        _ctx = self._select("withTrivyScanOutput", _args)
        return Env(_ctx)
...
class Client(Root):
    ...
    def load_trivy_from_id(self, id: TrivyID) -> "Trivy":
        """Load a Trivy from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadTrivyFromID", _args)
        return Trivy(_ctx)

    def load_trivy_scan_from_id(self, id: TrivyScanID) -> "TrivyScan":
        """Load a TrivyScan from its ID."""
        _args = [
            Arg("id", id),
        ]
        _ctx = self._select("loadTrivyScanFromID", _args)
        return TrivyScan(_ctx)
    ...
    def trivy(self, *, version: str | None = None, container: Container | None = None, config: File | None = None, cache: CacheVolume | None = None, database_repository: str | None = None, warm_database_cache: bool | None = None,) -> "Trivy":
        """Parameters
        ----------
        version:
            Version (image tag) to use from the official image repository as a
            base container.
        container:
            Custom container to use as a base container. Takes precedence over
            version.
        config:
        ...
        database_repository:
            OCI repository to retrieve trivy-db from. (default
        ...
        _args = [
            ...
            Arg("cache", cache, None),
            Arg("databaseRepository", database_repository, None),
            Arg("warmDatabaseCache", warm_database_cache, None),
        ]
        _ctx = self._select("trivy", _args)
        return Trivy(_ctx)
...
class Trivy(Type):
    ...
    def binary(self, binary: File, *, config: File | None = None,) -> "TrivyScan":
        """
        Scan a binary.

        This is a convenience method to scan a binary file that normally falls
        under the rootfs target.

        See https://aquasecurity.github.io/trivy/latest/docs/target/rootfs/
        ...
        _ctx = self._select("binary", _args)
        return TrivyScan(_ctx)

    def container(self, container: Container, *, config: File | None = None,) -> "TrivyScan":
        """
        Scan a container.

        See https://aquasecurity.github.io/trivy/latest/docs/target/container_
    ...
    def filesystem(self, directory: Directory, *, target: str | None = ".", config: File | None = None,) -> "TrivyScan":
        """
        Scan a filesystem.

        See
        https://aquasecurity.github.io/trivy/latest/docs/target/filesystem/
        for more information.
        ...
        _ctx = self._select("filesystem", _args)
        return TrivyScan(_ctx)

    def helm_chart(self, chart: File, *, set: list[str] | None = None, set_string: list[str] | None = None, values: list[File] | None = None, kube_version: str | None = None, api_versions: list[str] | None = None, config: File | None = None,) -> "TrivyScan":
        """
        Scan a Helm chart.
        ...
        set:
            Inline values for the Helm chart (equivalent of --set parameter of
            the helm install command).
        set_string:
            Inline values for the Helm chart (equivalent of --set-string
            parameter of the helm install command).
        values:
            Values files for the Helm chart (equivalent of --values parameter
        ...
        _args = [
            Arg("chart", chart),
            Arg("set", set, None),
            Arg("setString", set_string, None),
            Arg("values", values, None),
            Arg("kubeVersion", kube_version, None),
            Arg("apiVersions", api_versions, None),
            Arg("config", config, None),
        ]
        _ctx = self._select("helmChart", _args)
        return TrivyScan(_ctx)

    async def id(self) -> TrivyID:
        ...
        -------
        TrivyID
            The `TrivyID` scalar type represents an identifier for an object
            of type Trivy.
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(TrivyID)

    def image(self, image: str, *, config: File | None = None,) -> "TrivyScan":
        """
        ...
        _ctx = self._select("image", _args)
        return TrivyScan(_ctx)

    def image_tarball(self, image: File, *, config: File | None = None,) -> "TrivyScan":
        """
        ...
        _ctx = self._select("imageTarball", _args)
        return TrivyScan(_ctx)

    def rootfs(self, directory: Directory, *, target: str | None = ".", config: File | None = None,) -> "TrivyScan":
        """
    ...
    def sbom(self, sbom: File, *, config: File | None = None,) -> "TrivyScan":
        """
        Scan an SBOM.

        See https://aquasecurity.github.io/trivy/latest/docs/target/sbom/ for
        more information.
...
@typecheck
class TrivyScan(Type):

    async def id(self) -> TrivyScanID:
        """A unique identifier for this TrivyScan.
        ...
        _args: list[Arg] = []
        _ctx = self._select("id", _args)
        return await _ctx.execute(TrivyScanID)

    async def output(self, *, format: str | None = None) -> str:
        """
    ...
    def report(self, format: str) -> File:
        """
